...
namespace Sandbox.WebAPI.Controllers
{
    ...
    public class MarginTradingController : ControllerBase
    {
        ...
        public MarginTradingController(IServiceProvider serviceProvider)
        {
            var orderServiceProvider = serviceProvider.GetRequiredService<IKeyedServiceProvider>().GetRequiredKeyedService<IOrderService>("Margin");;
            _orderService = orderServiceProvider;
        }
