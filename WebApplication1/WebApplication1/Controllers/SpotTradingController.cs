...
namespace Sandbox.WebAPI.Controllers
{
    ...
    public class SpotTradingController : ControllerBase
    {
        ...
        public SpotTradingController(IServiceProvider serviceProvider)
        {
            var orderServiceProvider = serviceProvider.GetRequiredService<IKeyedServiceProvider>().GetRequiredKeyedService<IOrderService>("Spot");;
